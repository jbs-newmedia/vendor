...
var popover = renderer["a" /* default */].create(['<div class="note-popover popover show">', '<div class="popover-arrow"></div>', '<div class="popover-content note-children-container"></div>', '</div>'].join(''), function ($node, options) {
...
var ui_ui = function ui(editorOptions) {
  return {
    ...
    button: function button($node, options) {
      return renderer["a" /* default */].create('<button type="button" class="note-btn btn btn-light btn-sm">', function ($node, options) {
