...
foreach (glob(\osWFrame\Core\Settings::getStringVar('settings_framepath') . 'oswvendor' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . '*') as $vendor) {
...
foreach ($vendor_settings as $v => $vv) {
    $this->fields['vendor_class_' . $v . '_version'] = ['default_name' => $v, 'default_type' => 'select', 'default_select' => array_merge(['0' => 'newest'], $vv), 'default_value' => '', 'valid_type' => 'oswvendor', 'valid_min_length' => 1, 'valid_max_length' => 32, 'configure_write' => true];
